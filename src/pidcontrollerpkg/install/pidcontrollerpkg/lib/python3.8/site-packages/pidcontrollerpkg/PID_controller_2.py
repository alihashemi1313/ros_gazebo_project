...
class MinimalClientAsync(Node):
    ...
    def __init__(self):
        ...
        self.e_integ1 = 0.0
        self.f1 = 0.0   # torque
        self.Theta_goal_J1 = 0 #Desierd Value 6RJ1
        ...
        self.e_integ2 = 0.0
        self.f2 = 0.0   # torque
        self.Theta_goal_J2 = 0 #Desierd Value 6RJ2
        ...
        self.e_integ3 = 0.0
        self.f3 = 0.0   # torque
        self.Theta_goal_J3 = 0 #Desierd Value 6RJ3
        ...
        self.e_integ4 = 0.0
        self.f4 = 0.0   # torque
        self.Theta_goal_J4 = 0 #Desierd Value 6RJ4
        ...
        self.e_integ5 = 0.0
        self.f5 = 0.0   # torque
        self.Theta_goal_J5 = 0 #Desierd Value 6RJ5
        ...
        self.e_integ6 = 0.0
        self.Theta_goal_J6= 0 #Desierd Value 6RJ6
...
# send request to Service 
    ...
    def send_request(self):
        ...
        while self.counter <= Decimal(5.000) :   # total time in seconds
            ...
            self.Theta_goal_J1 = 0
            self.Theta_goal_J2 = math.sin(2.0 * math.pi / 5 * t)
            self.Theta_goal_J3 = 0.25
            self.Theta_goal_J4 = 0
            self.Theta_goal_J5 = 0
            self.Theta_goal_J6 = 0
