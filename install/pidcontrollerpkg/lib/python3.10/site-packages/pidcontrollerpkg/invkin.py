...
def get_wrist_center(gripper_point, R0g, dg = 0.135):
...
def get_first_three_angles(wrist_center):
  ...
  a1, a2, a3 = 0, 0.6, 0.2
  d1, d4 = 0.326, 0.6855
  l = 0.7140800025 # get_hypotenuse(d4, abs(a3))
  phi = 1.2977 # atan2(d4, abs(a3))
...
def get_angles(x, y, z, roll, pitch, yaw):
  ...
  T0g_a = Matrix([
    [((sin(q1)*sin(q4) + sin(q2 + q3)*cos(q1)*cos(q4))*cos(q5) + sin(q5)*cos(q1)*cos(q2 + q3))*cos(q6) - (-sin(q1)*cos(q4) + sin(q4)*sin(q2 + q3)*cos(q1))*sin(q6), -((sin(q1)*sin(q4) + sin(q2 + q3)*cos(q1)*cos(q4))*cos(q5) + sin(q5)*cos(q1)*cos(q2 + q3))*sin(q6) + (sin(q1)*cos(q4) - sin(q4)*sin(q2 + q3)*cos(q1))*cos(q6), -(sin(q1)*sin(q4) + sin(q2 + q3)*cos(q1)*cos(q4))*sin(q5) + cos(q1)*cos(q5)*cos(q2 + q3), -0.135*sin(q1)*sin(q4)*sin(q5) + 0.6*sin(q2)*cos(q1) - 0.135*sin(q5)*sin(q2 + q3)*cos(q1)*cos(q4) - 0.2*sin(q2 + q3)*cos(q1) + 0.135*cos(q1)*cos(q5)*cos(q2 + q3) + 0.6855*cos(q1)*cos(q2 + q3) + 0*cos(q1)],
    [ ((sin(q1)*sin(q2 + q3)*cos(q4) - sin(q4)*cos(q1))*cos(q5) + sin(q1)*sin(q5)*cos(q2 + q3))*cos(q6) - (sin(q1)*sin(q4)*sin(q2 + q3) + cos(q1)*cos(q4))*sin(q6), -((sin(q1)*sin(q2 + q3)*cos(q4) - sin(q4)*cos(q1))*cos(q5) + sin(q1)*sin(q5)*cos(q2 + q3))*sin(q6) - (sin(q1)*sin(q4)*sin(q2 + q3) + cos(q1)*cos(q4))*cos(q6), -(sin(q1)*sin(q2 + q3)*cos(q4) - sin(q4)*cos(q1))*sin(q5) + sin(q1)*cos(q5)*cos(q2 + q3),  0.6*sin(q1)*sin(q2) - 0.135*sin(q1)*sin(q5)*sin(q2 + q3)*cos(q4) - 0.2*sin(q1)*sin(q2 + q3) + 0.135*sin(q1)*cos(q5)*cos(q2 + q3) + 0.6855*sin(q1)*cos(q2 + q3) + 0*sin(q1) + 0.135*sin(q4)*sin(q5)*cos(q1)],
    [                                                                -(sin(q5)*sin(q2 + q3) - cos(q4)*cos(q5)*cos(q2 + q3))*cos(q6) - sin(q4)*sin(q6)*cos(q2 + q3),                                                                  (sin(q5)*sin(q2 + q3) - cos(q4)*cos(q5)*cos(q2 + q3))*sin(q6) - sin(q4)*cos(q6)*cos(q2 + q3),                                     -sin(q5)*cos(q4)*cos(q2 + q3) - sin(q2 + q3)*cos(q5),                                                                                 -0.135*sin(q5)*cos(q4)*cos(q2 + q3) - 0.135*sin(q2 + q3)*cos(q5) - 0.6855*sin(q2 + q3) + 0.6*cos(q2) - 0.2*cos(q2 + q3) + 0.326],
    [                                                                                                                                                            0,                                                                                                                                                             0,                                                                                        0,                                                                                                                                                                                                              1]])
  ...
  wrist_center = get_wrist_center(gripper_point, R0g_eval, dg = 0.135)
