...
class inv_kin():
    ...
    def inv_k(self,x,y,z,roll,pitch,yaw,t1,t2,t3,t4,t5,t6):
        ...
        if math.sqrt(Qg6**2+Qg7**2+(Qg8-389.5)**2) >= ((600+math.sqrt(200**2+685.5**2))-0.5):
            Q[1] = CurPos [1]
            print('Reach')
...
def main(args=None):
    ...
    # Create an object
    invK = inv_kin()
    Q = invK.inv_k(1000, 1, 1, 0, 1.57, 0, 0, 0, 0, 0, 0, 0)
    print(Q)
